    ...
    public partial class Khachhang : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd1 = new SqlCommand("SELECT _PASSWORD FROM ACCOUNT WHERE _USERNAME='" + Login._id + "'", provider.Connect);
                provider.Connect.Open();
                var temp = cmd1.ExecuteReader();
                while (temp.Read())
                {
                    Login._password = temp.GetString(0);
                }
