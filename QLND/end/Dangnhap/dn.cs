...
namespace Dangnhap
{
    public partial class Login : Form
    {
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("SELECT  ACCOUNT_ID FROM ACCOUNT WHERE _USERNAME ='" + txt_taikhoan.Text + "' AND _PASSWORD='"+ txt_matkhau.Text+"'", provider.Connect);
